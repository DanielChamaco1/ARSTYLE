...
jQuery(window).on("load", function () {
  ...
  jQuery(document).ready(function () {
    ...
    $(document).on("touchstart click", function (t) {
      0 != $(t.target).parents(".left-side-bar").length ||
        $(t.target).is(".menu-icon, .menu-icon img") ||
  ...
  (function (n) {
    n.fn.vmenuModule = function (t) {
      var e,
        o,
        a = n.extend({ Speed: 220, autostart: !0, autohide: 1 }, t);
      (o = (e = n(this)).find("ul").parent("li").children("a")).attr(
        "data-option",
        "off"
      ),
        o.unbind("click").on("click", function () {
          ...
          a.autohide &&
            t
              ...
              .parent("li")
              .children("ul")
              .slideUp(a.Speed / 1.2, function () {
                n(this).parent("li").children("a").attr("data-option", "off"),
                  n(this).parent("li").removeClass("show");
              }),
            "off" == t.attr("data-option") &&
              t
                .parent("li")
                .children("ul")
                .slideDown(a.Speed, function () {
                  t.attr("data-option", "on"), t.parent("li").addClass("show");
                }),
            "on" == t.attr("data-option") &&
              (t.attr("data-option", "off"),
              t.parent("li").children("ul").slideUp(a.Speed),
              t.parent("li").removeClass("show"));
        }),
        a.autostart
          ...
          : e.find("a.active").each(function () {
              n(this)
                ...
                .slideDown(a.Speed, function () {
                  n(this).parent("li").children("a").attr("data-option", "on"),
                    n(this).parent("li").addClass("show");
                });
            });
    };
